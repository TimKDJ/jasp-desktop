...
test_that("Main table results match", {
  ...
  results <- JASPTools::run("TTestBayesianIndependentSamples", "debug.csv", options, view=FALSE)
...
test_that("Prior posterior plot matches", {
  ...
  results <- suppressWarnings(JASPTools::run("TTestBayesianIndependentSamples", "debug.csv", options, view=FALSE))
